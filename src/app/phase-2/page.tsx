...
const COMPONENTS = [
  ...
  },
  {
    ...
    subtitle: "MultiWA — Zero Per-Seat Fees",
    description:
    ...
    why: "10M+ Romanians use WhatsApp daily. Orange has zero presence. Every competitor who deploys first owns that channel permanently. This is a first-mover window closing within 12 months.",
    color: "#30d158",
  },
  {
    id: "security",
    ...
    subtitle: "5-Layer Defence Stack",
    description:
    ...
    why: "An AI infrastructure without a hardened perimeter is a liability, not an asset. Orange's regulatory exposure under NIS2 and GDPR makes this non-negotiable at the infrastructure layer.",
    color: "#ff453a",
  },
  {
    id: "knowledge",
  ...
  },
  {
    id: "integration",
    icon: "🔗",
    title: "Genesys/MATRIXX Integration",
    subtitle: "Vendor-Agnostic API Bridges",
    description:
    ...
    why: "Orange cannot rip-and-replace €40M+ in vendor contracts. These bridges protect sunk costs while unlocking AI capability — extending existing infrastructure rather than replacing it.",
    color: "#6e3aff",
  },
]
...
const TIMELINE = [
  ...
  },
  {
    ...
    items: [
      ...
      "B2B pipeline first run",
      "Lead scoring model calibrated",
      "CRM enrichment flowing",
    ],
    color: "#30d158",
  },
  {
...
const KPIS = [
  ...
  {
    metric: "WhatsApp Channel Revenue",
    baseline: "€0 (no channel)",
    target: "First revenue within 30 days of go-live",
    method: "Tracked via WhatsApp-attributed conversions in CRM",
    icon: "💬",
  },
  {
