    ...
    <div className="bg-white text-[#1d1d1f] font-sans overflow-x-hidden">
      ...
      <section className="relative bg-[#1d1d1f] text-white overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-32">
          ...
          <AnimateIn delay={0.2}>
            <p className="text-xl text-white/80 max-w-2xl leading-relaxed mb-16">
      ...
      <section className="bg-[#1d1d1f] text-white py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <AnimateIn>
            ...
            <p className="text-white/85 text-xl max-w-2xl mb-16 leading-relaxed">
                ...
                {BREAKDOWN.map((item, i) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-white/80 text-sm">{item.note}</div>
                    </div>
                  ...
                  {[
                    ...
                    <div key={alt.name} className="flex items-center justify-between p-5">
                      <div>
                        ...
                        <div className="text-white/80 text-sm">{alt.note}</div>
                      </div>
            ...
            <div className="max-w-5xl mx-auto mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-3 relative">
                ...
                <div className="rounded-2xl bg-[#ff7900] p-6 relative shadow-lg shadow-[#ff7900]/20">
                  ...
                  <div className="text-[11px] font-bold uppercase tracking-wider text-white/85 mb-3">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            <AnimateIn>
              ...
              <p className="text-white/85 text-xl max-w-2xl mx-auto leading-relaxed mb-12">
            ...
            <div className="border border-white/10 rounded-2xl p-8 max-w-3xl mx-auto">
              ...
              <div className="border-t border-white/10 mt-6 pt-6 text-center">
                <p className="text-white/75 text-sm">
                  APEX OS is delivered through <strong className="text-white/85">InfoAcademy</strong> - 
      ...
      <footer className="bg-[#1d1d1f] border-t border-white/10 py-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/80 text-sm">APEX OS × InfoAcademy</span>
            <span className="text-white/70 text-sm">·</span>
            <span className="text-white/80 text-sm">Orange Romania Phase 2 Proposal</span>
          </div>
