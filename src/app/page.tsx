...
const LEADERSHIP = [
  {
    ...
    photo: "/team/nico.png",
    location: "London, UK",
    title: "Founder & CEO, InfoAcademy × APEX OS",
    org: "InfoAcademy × APEX OS",
    bio: "Founder & CEO of InfoAcademy × APEX OS, the sovereign AI operating system running 24/7 on Azure with 400+ self-evolving skills, persistent agent memory, multi-model orchestration, self-healing infrastructure, and a knowledge distillation engine. Background spans 5 years of network engineering at Lloyds Banking Group (cloud migrations and operational transformation), business analysis and project & programme management across FinTech and RegTech, and scalable platforms built from scratch. Chief Customer Office at CUBE Global. Helps founders and businesses move from concept to execution with battle-tested frameworks, AI automation, and hands-on technical expertise. Architect, overseer, cognitive-intelligence layer, deployer, shipper.",
    credentials: [
      { company: "InfoAcademy × APEX OS", detail: "Founder & CEO. 400+ skills, self-healing, 24/7 sovereign governance, existing Orange Romania vendor" },
