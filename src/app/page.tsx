...
const PAIN_POINTS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Every email is manually read, sorted, and forwarded. Urgent issues sit next to billing questions in the same inbox",
      "At this volume it never gets better. It only grows, and every delay risks a customer escalation",
    ],
    color: "#0071e3",
  },
  {
  ...
  },
  {
    ...
    bullets: [
      "Internal teams are already using ChatGPT, Claude, and LangChain independently, with no coordination",
  ...
  },
  {
    ...
    bullets: [
      "Orange Group's 'Trust the Future' 2026-2030 strategy targets €600M in AI-generated value by 2028. That's a revenue commitment, not a budget (Reuters, Feb 2026)",
...
const LEADERSHIP = [
  {
    ...
    photo: "/team/nico.png",
    location: "London, UK",
    title: "Founder & CEO, APEX OS",
    org: "APEX OS · InfoAcademy",
    bio: "Founder & CEO of APEX OS, the sovereign AI operating system running 24/7 on Azure with 400+ self-evolving skills, persistent agent memory, multi-model orchestration, self-healing infrastructure, and a knowledge distillation engine. Also runs InfoAcademy, Orange Romania's existing training vendor. Background spans 5 years of network engineering at Lloyds Banking Group (cloud migrations and operational transformation), business analysis and project & programme management across FinTech and RegTech, and scalable platforms built from scratch. Chief Customer Office at CUBE Global. Helps founders and businesses move from concept to execution with battle-tested frameworks, AI automation, and hands-on technical expertise. Architect, overseer, cognitive-intelligence layer, deployer, shipper.",
    credentials: [
      { company: "APEX OS", detail: "Founder & CEO. 400+ skills, self-healing, 24/7 sovereign governance" },
      { company: "InfoAcademy", detail: "CEO. Existing Orange Romania vendor, 20K+ learners" },
      { company: "Lloyds Banking Group", detail: "Network engineering, AI/ML adoption, cloud migrations (5 years)" },
...
const TEAM = [
  {
    ...
    credentials: [
      ...
      { company: "Emerson", detail: "SCADA patent holder (Oil & Gas)" },
...
const OBJECTIONS = [
  {
    ...
    a: "One engineer builds tools. We transfer architectural capability across your organisation. One person doesn't transform 12 people into AI-capable builders. Our team brings 40+ years combined enterprise experience from Lloyds, HP, Telenav, Visa and PayPoint, plus 73 production repos of battle-tested patterns.",
  },
  {
  ...
  },
  {
    ...
    a: "Paris builds tools. Tools without people who know how to use them are shelfware. We build the people AND the architecture. Bucharest delivering measurable AI value positions you as the Group's AI innovation lab. That's political capital for your leadership.",
  },
  {
    q: "€30K-€50K seems cheap for 'architecture' but expensive for 'training'.",
    a: "It's neither. It's a 10-week build program where your people create working AI agents under expert guidance. The architecture emerges from what they build. You get trained people, working agents, and a roadmap. Price scales with the scope you pick (number of workflows, agents, and integrations). Still below VP discretionary spend threshold.",
  },
];
  ...
  return (
    <AnimateIn delay={index * 0.08} className="h-full">
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className="h-full cursor-pointer rounded-2xl p-6 transition-all"
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="text-right">
          ...
          {"scopeNote" in phase && phase.scopeNote && (
            <div className="text-[10px] font-medium uppercase tracking-wider text-white/80 mt-0.5">{phase.scopeNote}</div>
          )}
          <ChevronDown
            size={16}
            className="text-white/85 ml-auto mt-1 transition-transform duration-300"
    ...
    <main>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden"
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-6 text-center">
          <AnimateIn>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5">
                ...
                <span className="text-[12px] text-white/80 uppercase tracking-widest font-medium">
          ...
          <AnimateIn delay={0.2}>
            <p className="text-lg sm:text-xl text-white/85 mt-6 max-w-[640px] mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16">
              {[
                ...
                <div key={i} className="text-center">
                  ...
                  <div className="text-[11px] text-white/80 uppercase tracking-widest mt-1">{s.label}</div>
                </div>
              ))}
            </div>
          </AnimateIn>
      ...
      <section id="offer" className="py-24 px-6 bg-[#1d1d1f]">
        <div className="max-w-[900px] mx-auto text-center">
          <AnimateIn>
            ...
            <p className="text-lg text-white/85 mt-6 max-w-[680px] mx-auto leading-relaxed">
            ...
            <div className="grid sm:grid-cols-3 gap-6 mt-10">
              {[
                ...
                <div key={i} className="h-full flex flex-col rounded-2xl p-6 bg-white/5 border border-white/[0.07] text-left">
                  ...
                  <p className="text-[13px] text-white/85 leading-relaxed flex-1">{s.desc}</p>
                </div>
              ))}
            </div>
          </AnimateIn>
            ...
            <div className="grid grid-cols-3 gap-0 mt-12 rounded-2xl overflow-hidden border border-white/[0.07] text-left text-[13px]">
              {[
                ...
                <div key={i} className="contents">
                  <div className={`px-4 py-3 ${i === 0 ? "font-black text-[11px] uppercase tracking-widest text-white/75 bg-white/[0.04]" : "text-white/80"} border-b border-white/[0.05]`}>{row.label}</div>
                  ...
                  <div className={`px-4 py-3 ${i === 0 ? "font-black text-[11px] uppercase tracking-widest text-white/75 bg-white/[0.04]" : "text-white/75"} border-b border-l border-white/[0.05]`}>{row.them}</div>
                </div>
              ))}
            </div>
          </AnimateIn>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <AnimateIn key={i} delay={i * 0.1} className="h-full">
                <div className="h-full flex flex-col rounded-2xl p-7 border border-[#e8e8ed] hover:border-[#d0d0d7] transition-colors">
                  ...
                  <p className="text-[13px] text-[#6e6e73] leading-relaxed flex-1">{item.value}</p>
                </div>
              </AnimateIn>
            ))}
          </div>
      ...
      <section id="team" className="py-24 px-6">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {TEAM.map((person, i) => (
              <AnimateIn key={i} delay={i * 0.1 + 0.2} className="h-full">
                <TeamCard person={person} />
              </AnimateIn>
            ))}
          </div>
        ...
        <div className="max-w-[1000px] mx-auto">
          <AnimateIn>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/80 mt-4">Start at Phase 1. Scale when ready. Stop any time, you keep everything.</p>
            </div>
          </AnimateIn>
            ...
            <div className="rounded-2xl overflow-hidden mb-6" style={{ border: "1px solid #ff790025" }}>
              ...
              <div className="p-7 flex flex-col sm:flex-row items-start justify-between gap-4"
                ...
                <div className="flex-shrink-0 text-right">
                  ...
                  <div className="text-[12px] text-white/75 mt-0.5">10 weeks · based on scope</div>
                </div>
              </div>
              {/* Split body */}
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-7 border-b md:border-b-0 md:border-r border-white/[0.06]">
                  <p className="text-[11px] font-black uppercase tracking-widest text-white/70 mb-5">10-Week Program</p>
                  <div className="space-y-5">
                    {[
                      ...
                      { week: "W3-6", title: "Build Sprint", desc: "Each team picks a real Orange use case (network triage, knowledge base, procurement analysis). Orange chooses the workflow. We guide the build.", color: "#0071e3" },
                      ...
                      <div key={i} className="flex gap-4 items-start">
                        ...
                        <div>
                          ...
                          <p className="text-[12px] text-white/80 mt-0.5 leading-relaxed">{w.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {/* Right: Deliverables */}
                <div className="p-7">
                  <p className="text-[11px] font-black uppercase tracking-widest text-white/70 mb-5">What You Get</p>
      ...
      <section id="cta" className="py-24 px-6"
        ...
        <div className="max-w-[700px] mx-auto text-center">
          ...
          <AnimateIn delay={0.22}>
            <p className="text-[11px] text-white/80 uppercase tracking-widest mt-14">
