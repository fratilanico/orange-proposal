...
const LEADERSHIP = [
  {
    ...
    bio: "I build the future by solving problems that matter. Co-CEO of InfoAcademy and founder of InfoAcademy × APEX OS. I help founders and businesses move from concept to execution using battle-tested frameworks, AI automation, and hands-on technical expertise. Architect, overseer, cognitive-intelligence layer, deployer, shipper. My background spans AI/ML adoption at Lloyds Banking Group (cloud migrations and operational transformation), business analysis across fintech and education, and scalable platforms built from scratch. Curiosity drives me. Technology empowers me. Results define me.",
    credentials: [
